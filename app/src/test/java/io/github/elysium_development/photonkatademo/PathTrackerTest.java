...
public class PathTrackerTest {
    ...
    private PathTracker subject;

    @Before
    public void setUp() {
        subject = new PathTracker(2);
    }
    ...
    public void isOverCostIfCostExceedsMaximum() {
        subject.addRowWithCost(1, PathTracker.MAXIMUM_COST + 1);
        assertThat(subject.isOverCost(), is(true));
    }

    @Test
    public void isNotOverCostIfCostDoesNotExceedMaximum() {
        subject.addRowWithCost(1, PathTracker.MAXIMUM_COST);
    ...
    public void copyConstructorMakesAnExactCopyOfPath() {
        ...
        PathTracker copy = new PathTracker(subject);
